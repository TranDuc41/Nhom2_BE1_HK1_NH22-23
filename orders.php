                                        ...
                                        <tbody>
                                                ...
                                                <td class="actions" colspan="6">
                                                   <div class="add-to-cart">
                                                                    ...
                                                                    <button class="add-to-cart-btn"><a style="text-decoration: none;" href="delorder.php?id=<?php echo $value['id'] ?>"><i class="fa fa-credit-card"></i> HỦY ĐƠN HÀNG</a></button>
                                                                    <button class="add-to-cart-btn"><a style="text-decoration: none;" href="received.php?id=<?php echo $value['id'] ?>"><i class="fa fa-credit-card"></i> ĐÃ NHẬN HÀNG</a>
                                                                    </button>
